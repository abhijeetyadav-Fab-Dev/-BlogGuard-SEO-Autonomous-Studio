...
def generate_html_report(article_data, audit_results, serp_data=None):
    ...
    if serp_data and serp_data.get("competitors"):
        comp_html += "<h2 style='color: #0f172a; margin-top: 30px;'>Top Google SERP Competitors</h2>"
...
<style>
    ...
    .metric-val {{ font-size: 24px; font-weight: 700; color: #0f172a; margin-top: 4px; }}
...
<div class="container">
    ...
    <div style="margin-top: 40px; padding-top: 16px; border-top: 1px solid #e2e8f0; font-size: 12px; color: #94a3b8; text-align: center;">
        Generated autonomously by BlogGuard SEO Platform • Google SERP & DeepSeek AI Assisted
    </div>
</div>
</body>
</html>
